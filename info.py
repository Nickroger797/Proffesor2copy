...
# Bot information
SESSION = environ.get('SESSION', 'movies bot')
...
PICS = (environ.get('PICS', 'https://i.imgur.com/IOhm6ef.jpeg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5860228893').split()] # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001747397870') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002482932594')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002429417244')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://godlikeadi02:three@cluster3.5q9qt.mongodb.net/?retryWrites=true&w=majority&appName=Cluster3")   # IF Multiple Database Is False Then Fill Only This Database Url.
